...
(defface mixed-pitch-variable-pitch
  '((t :inherit variable-pitch))
  "Face for variable pitch text areas, where the :family, :height, and :weight properties are considered."
  :group 'mixed-pitch)
...
inherited from `variable-pitch' and `default'."
  :lighter " MPM"
  (let ((var-pitch (face-attribute 'mixed-pitch-variable-pitch :family nil t))
        (var-height (face-attribute 'mixed-pitch-variable-pitch :height nil t))
        (var-weight (face-attribute 'mixed-pitch-variable-pitch :weight nil t))
            ...
            (add-to-list 'mixed-pitch-fixed-cookie
                         (if mixed-pitch-set-height
                             (face-remap-add-relative
                              face
                              :family fix-pitch
                              :height (or (and (facep face) (face-attribute face :height))
                                          fix-height)
                              :weight (or (and (facep face) (face-attribute face :weight))
                                          fix-weight))
